...
function search_table_status($status,$user)
{
    ...
    echo "<table><tr><th>PMID</th><th>Title</th><th>Auteurs</th><th>Status</th><th>User</th></tr>";
    foreach($table_a_afficher as $line_table)#création du tableau à afficher ligne par ligne en fonction du statut demandés
    {
        ...
        echo "<tr id = line_$num_access><td>" . $lien_pubmed .  $num_access . "</a></td><td>" . $survol_title . $line_table["title"] . "</a></td><td>premier et dernier auteur</td><td>" . $list_status . "</td><td>" . $list_user . "</td></tr>" ;
